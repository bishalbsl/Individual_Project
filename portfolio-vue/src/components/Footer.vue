    ...
    <div class="container-fluid bg-primary text-white mt-5 py-1 px-sm-1 px-md-5">
        <div class="container text-center py-5">
            <div class="d-flex justify-content-center mb-4">
                <a class="btn btn-light btn-social mr-2" href="https://www.facebook.com/bishalsl.shakya"><i class="fa fa-facebook"></i></a>
                <a class="btn btn-light btn-social mr-2" href="mailto:bsalsakya@gmail.com"><i class="fa fa-google"></i></a>
